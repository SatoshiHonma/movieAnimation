...
"""
with open(r'/Users/honmasatoshi/OneDrive - 東京理科大学/研究データ/2.5動画/CIMG0839.csv') as f:
    #print(f.read())
    reader = csv.reader(f)
...
def animate(k):
    ...
    #ax.plot( x[0:k], y[0:k],linestyle='solid',color="red",marker="o")
    plt.title("gaze_angle_y(CIMG0839)"+timestamp[k])
...
ani.save('gaze_angle_y(CIMG0839).mp4', writer='ffmpeg')
#plt.show
"""
pos = 0      # 描画時点の時間位置
def animate(i):
